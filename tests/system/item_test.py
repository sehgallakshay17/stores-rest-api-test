    ...
    def test_create_item(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({'name': 'test', 'price': 17.99}, json.loads(reponse.data))
    ...
    def test_create_duplicate_item(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({'message': "An item with name \'test\' already exists."}, json.loads(reponse.data))
